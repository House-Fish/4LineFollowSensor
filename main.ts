/*
 _4line_follow_sensor package
*/
//% weight=10 icon="\uf7a5" color=#2896ff
namespace _4line_follow_sensor {
    ...
    //% weight=96 blockId=line_followers block="4 Line follower %lineFollowerSensor at port 4 (P19:SCL,P20:SDA) in %lineColor ?"
